...
with the <code>@XmlAccessorType(XmlAccessType.PROPERTY)</code> JAXB annotation.</li>
...
@see org.mybatis.generator.plugins.jaxbAnnotations.FieldTypeJaxbAnnotations  FieldTypeJaxbAnnotations
*/
public class PropertyTypeJaxbAnnotations extends AbstractJaxbAnnotations
{
