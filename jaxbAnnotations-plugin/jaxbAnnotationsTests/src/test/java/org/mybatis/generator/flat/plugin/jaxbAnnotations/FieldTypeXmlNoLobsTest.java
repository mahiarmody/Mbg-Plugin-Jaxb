...
import flat.fieldType.noLobs.modelDto.*; //these are our mbg generated compiled model classes that we want to test.
import flat.fieldType.noLobs.clientDao.*;
...
public class FieldTypeXmlNoLobsTest
{
	...
	@Test
	public void testClobAndBlobsNotMarashalled() throws XPathExpressionException, JAXBException
	{
		String clobStrNarrative = null, clobStrSummary=null, blobVideo = null;
		...
		sb.delete(0, sb.length());
		blobVideo = getValueFromXml(userTutorial, "/Tutorial/video");
		...
		Assert.assertNull("Failure: UserTutorial.video should not be marshalled. But it is.", blobVideo);
	}
