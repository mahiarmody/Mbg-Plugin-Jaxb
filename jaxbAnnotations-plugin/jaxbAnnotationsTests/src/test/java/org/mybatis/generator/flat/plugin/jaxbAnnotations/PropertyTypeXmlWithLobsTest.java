...
import flat.propertyType.withLobs.modelDto.*; //these are our mbg generated compiled model classes that we want to test.
import flat.propertyType.withLobs.clientDao.*;
...
public class PropertyTypeXmlWithLobsTest
{
	...
	public static void setUpBeforeClass() throws JAXBException, IOException
	{
		...
		JAXBContext jaxbContext = JAXBContext.newInstance(Users.class, UserSkills.class,
	...
	public void testClobsGenerated() throws XPathExpressionException, JAXBException
	{
		...
		Assert.assertEquals("Failure - CLOB datatype value incorrect.", "bla bla bla", clobStr);
	}



	@Test
	public void testLobsAreMarshalled() throws XPathExpressionException, JAXBException
	{
	...
	@Test
	public void testNonLobPropertyIsMarshalled() throws XPathExpressionException, JAXBException
	{
