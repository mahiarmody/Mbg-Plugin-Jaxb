...
import hierarchical.fieldType.noLobs.clientDao.*;
...
public class FieldTypeXmlNoLobsTest
{
	...
	public void testBlobsIgnored() throws MarshalException, XPathExpressionException, JAXBException
	{
		...
		try
		{
			...
			UserPhotosWithBLOBs userPhotosWithBLOBs = lstUserPhotosWithBLOBs.get(0);
	...
	public void testRecordWithBlobsNotAnnotated() throws MarshalException, XPathExpressionException, JAXBException
	{
		...
		Assert.fail("Failure: No MarshalException thrown while marshaling CLOB & BLOB class: UserTutorialWithBLOBs.");
	}
