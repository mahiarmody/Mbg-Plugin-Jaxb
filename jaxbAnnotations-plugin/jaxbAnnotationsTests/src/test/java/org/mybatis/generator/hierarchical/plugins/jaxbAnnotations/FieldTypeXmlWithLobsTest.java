...
import hierarchical.fieldType.withLobs.clientDao.*;
...
public class FieldTypeXmlWithLobsTest
{
	...
	public void testClobsGenerated() throws XPathExpressionException, JAXBException
	{
		...
		try
		{
			...
			UserBlogWithBLOBs userBlogWithBLOBs = lstUserBlogWithBLOBs.get(0);
		...
		Assert.assertNotNull("Failure - CLOB datatype not marshalled.", clobStr);
		Assert.assertEquals("Failure - Value of CLOB marshalled datatype incorrect.", "bla bla bla", clobStr);
	}
